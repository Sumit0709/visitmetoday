...
const BasicProfilePreview = ({basicProfile}) => {
    ...
    const onSubmit = (event) => {
        ...
        navigate("edit/basicProfile", {state: basicProfile})
  ...
  return (
    <form>
        ...
        <div className="text-center" style={{color: "#875"}}>Update country/ motto/ Bio</div>

        <div className="text-center mt-4">
            <button onClick={onSubmit} style={{width:'80%', maxWidth:'500px'}} className="myButton">Click to update your Profile</button>
        </div>
        <hr className='mt-4'/>
    </form>
  )
...
export default BasicProfilePreview