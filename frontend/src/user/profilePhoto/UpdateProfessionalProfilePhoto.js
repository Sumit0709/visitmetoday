...
import { updateProfessionaProfilePhoto, updateProfilePhoto } from "../../apiCalls/profile";
...
const UpdateProfessionalProfilePhoto = () => {
    ...
    const onSubmit = (event) => {
        ...
        updateProfessionaProfilePhoto(token, sessionId, values.formData)
            .then(response => {
                if(response.success){
    ...
    return (
        <Base>
            <ProfessionalProfilePhoto sessionId={sessionId} imageDataURL={imageDataURL}/>
            <form>
                <div className="mt-4">
                    <div className="">
...
export default UpdateProfessionalProfilePhoto;