...
import { getCardFromUrl, getProfessionalCardFromUrl, getProfessionalProfileFromUrl, getProfileFromUrl, getProfileUrl } from '../apiCalls/profile'
...
const ProfessionalProfilePreview = () => {
    ...
    const url = `${process.env.REACT_APP_SERVER_API}/getProfilePhotoFromUrl/b/${profileUrl}`
    ...
    const loadProfile = async () => {
        getProfessionalProfileFromUrl(profileUrl)
            .then(data => {
                if(data.success){
    ...
    const onGetCardFromUrl = async () => {
        getProfessionalCardFromUrl(profileUrl)
        .then(blob => {
  ...
  return (
    <Base>
        ...
        <div className='text-center mt-4' style={{width: '80%', maxWidth:'400px', margin:'auto'}}>
            <strong>{profileData.dealsIn}</strong>
        </div>
        ...
        <div className='preview_container'>
            <div className='preview_basic'>
                ...
                <div className='preview_basic_item'>
                    ...
                    <div className='preview_basic_item_value'>{`${profileData.companyFirstName} ${profileData.companyMiddleName} ${profileData.companyLastName}`}</div>
                </div>
                {/* <div className='preview_basic_item'>
                ...
                <div className='preview_basic_item'>
                    <div className='preview_basic_item_title'>{"Online :"}</div>
                    <div className='preview_basic_item_value'>{profileData.sellOnline? "Available": "Not Available"}</div>
                </div>
                <div className='preview_basic_item'>
                    <div className='preview_basic_item_title'>{"Active Since :"}</div>
                    <div className='preview_basic_item_value'>{profileData.since}</div>
                </div>
                <div className='preview_basic_item'>
                ...
                { (!profileData.servesInArea || profileData.servesInArea == "")? <></> :
                <div className='preview_basic_item'>
                    {/* CHANGED MOTTO -> PERSONALITY */}
                    <div className='preview_basic_item_title'>{"Serves In :"}</div>
                    <div className='preview_basic_item_value'>{profileData.servesInArea}</div>
                </div>
                }
