...
import { getCard, getProfessionalProfileUrl, getProfileUrl, updateCard, updateCustomProfessionalProfileUrl, updateCustomProfileUrl } from '../../apiCalls/profile'
...
const UpdateCustomProfessionalUrl = () => {
    ...
    const getUserName = async () => {
        await getProfessionalProfileUrl(sessionId)
            .then(response => {
                if(response.success){
    ...
    const onSubmit = (event) => {
        ...
        updateCustomProfessionalProfileUrl(token, sessionId,{customUrl})
            .then(response => {
                if(response.success){
...
export default UpdateCustomProfessionalUrl;