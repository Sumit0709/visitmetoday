...
const professionalProfileSchema = new mongoose.Schema({ // Profile._id is automatically created and it gives the id of any particular profile
    signupId: {
    ...
    professionalProfileUrl: {// TODO::  String or Referencing, which to use?? => Referencing as it will help while updating it with custom url.
        // unique string that will be used to create unique profile url for a user
        type: mongoose.Types.ObjectId,
        ref: "ProfessionalUsedUrl",
