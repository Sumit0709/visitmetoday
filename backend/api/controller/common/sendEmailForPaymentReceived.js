...
exports.sendEmailForPaymentReceived = async ({to_name, to_email, sender_name, sender_email, amount}) => {
    ...
    const date = new Date();
    const currDate = date.toDateString() + "  " +date.toLocaleTimeString();
    ...
    const options = {
        ...
        //     }
        //   ],
          template_id: 'visitmetoday_paymentDone',
          variables: {NAME: to_name, DATE: currDate, AMOUNT: amount}
        })
      };
